...
ophys_mount_to_test_aind_ophys_decrosstalk_roi_images_9 = channel.fromPath(params.ophys_mount_url + "/*ophys/*MESO*.json", type: 'any')
ophys_mount_to_test_aind_ophys_decrosstalk_roi_images_10 = channel.fromPath(params.ophys_mount_url + "/pophys/*/V*_[0-9].h5", type: 'any')
capsule_aind_ophys_decrosstalk_split_session_json_2_to_capsule_test_aind_ophys_decrosstalk_roi_images_3_11 = channel.create()
capsule_aind_ophys_motion_correction_1_to_capsule_test_aind_ophys_decrosstalk_roi_images_3_12 = channel.create()
capsule_test_aind_ophys_decrosstalk_roi_images_3_to_capsule_aind_ophys_extraction_suite_2_p_4_13 = channel.create()
ophys_mount_to_aind_ophys_extraction_suite2p_14 = channel.fromPath(params.ophys_mount_url + "/data_description.json", type: 'any')
ophys_mount_to_aind_ophys_extraction_suite2p_15 = channel.fromPath(params.ophys_mount_url + "/session.json", type: 'any')
capsule_aind_ophys_extraction_suite_2_p_4_to_capsule_aind_ophys_dff_5_16 = channel.create()
capsule_aind_ophys_dff_5_to_capsule_aind_ophys_oasis_event_detection_8_17 = channel.create()
ophys_mount_to_processing_json_aggregator_18 = channel.fromPath(params.ophys_mount_url + "/*.json", type: 'any')
capsule_aind_ophys_oasis_event_detection_8_to_capsule_processingjsonaggregator_9_19 = channel.create()
ophys_mount_to_nwb_packaging_subject_capsule_20 = channel.fromPath(params.ophys_mount_url + "/", type: 'any')
ophys_mount_to_aind_ophys_nwb_21 = channel.fromPath(params.ophys_mount_url + "/", type: 'any')
...
capsule_test_aind_ophys_decrosstalk_roi_images_3_to_capsule_aind_ophys_nwb_11_26 = channel.create()
...
capsule_nwb_packaging_subject_capsule_10_to_capsule_aind_ophys_nwb_11_31 = channel.create()
...
process capsule_aind_ophys_motion_correction_1 {
	...
	path 'capsule/results/*' into capsule_aind_ophys_motion_correction_1_to_capsule_test_aind_ophys_decrosstalk_roi_images_3_12
...
process capsule_aind_ophys_decrosstalk_split_session_json_2 {
	...
	output:
	path 'capsule/results/*' into capsule_aind_ophys_decrosstalk_split_session_json_2_to_capsule_test_aind_ophys_decrosstalk_roi_images_3_11
...
process capsule_test_aind_ophys_decrosstalk_roi_images_3 {
	...
	input:
	path 'capsule/data/' from ophys_mount_to_test_aind_ophys_decrosstalk_roi_images_9.collect()
	path 'capsule/data/' from ophys_mount_to_test_aind_ophys_decrosstalk_roi_images_10.collect()
	path 'capsule/data/' from capsule_aind_ophys_decrosstalk_split_session_json_2_to_capsule_test_aind_ophys_decrosstalk_roi_images_3_11.flatten()
	path 'capsule/data/' from capsule_aind_ophys_motion_correction_1_to_capsule_test_aind_ophys_decrosstalk_roi_images_3_12.collect()

	output:
	path 'capsule/results/*'
	path 'capsule/results/*' into capsule_test_aind_ophys_decrosstalk_roi_images_3_to_capsule_aind_ophys_extraction_suite_2_p_4_13
	path 'capsule/results/*/decrosstalk/*.h5' into capsule_test_aind_ophys_decrosstalk_roi_images_3_to_capsule_aind_ophys_nwb_11_26
	...
	export CO_CAPSULE_ID=0562623f-2647-4504-b87c-265b947a4869
	export CO_CPUS=16
	export CO_MEMORY=137438953472
...
process capsule_aind_ophys_extraction_suite_2_p_4 {
	...
	input:
	path 'capsule/data/' from capsule_test_aind_ophys_decrosstalk_roi_images_3_to_capsule_aind_ophys_extraction_suite_2_p_4_13.flatten()
...
process capsule_aind_ophys_dff_5 {
	...
	output:
	path 'capsule/results/*'
	path 'capsule/results/*' into capsule_aind_ophys_dff_5_to_capsule_aind_ophys_oasis_event_detection_8_17
...
process capsule_aind_ophys_oasis_event_detection_8 {
	...
	input:
	path 'capsule/data/' from capsule_aind_ophys_dff_5_to_capsule_aind_ophys_oasis_event_detection_8_17

	output:
	path 'capsule/results/*'
	path 'capsule/results/*' into capsule_aind_ophys_oasis_event_detection_8_to_capsule_processingjsonaggregator_9_19
...
process capsule_processingjsonaggregator_9 {
	...
	input:
	path 'capsule/data/' from ophys_mount_to_processing_json_aggregator_18.collect()
	path 'capsule/data/' from capsule_aind_ophys_oasis_event_detection_8_to_capsule_processingjsonaggregator_9_19.collect()
...
process capsule_nwb_packaging_subject_capsule_10 {
	...
	input:
	path 'capsule/data/ophys_session' from ophys_mount_to_nwb_packaging_subject_capsule_20.collect()

	output:
	path 'capsule/results/*' into capsule_nwb_packaging_subject_capsule_10_to_capsule_aind_ophys_nwb_11_31
...
process capsule_aind_ophys_nwb_11 {
	...
	input:
	path 'capsule/data/raw' from ophys_mount_to_aind_ophys_nwb_21.collect()
	...
	path 'capsule/data/processed/' from capsule_test_aind_ophys_decrosstalk_roi_images_3_to_capsule_aind_ophys_nwb_11_26.collect()
	...
	path 'capsule/data/nwb/' from capsule_nwb_packaging_subject_capsule_10_to_capsule_aind_ophys_nwb_11_31.collect()
