...
// hash:sha256:42875a07582201fac79f3dfc6260e2a03312ac40ab5d36a715d72c8271864dd3
...
process capsule_aind_ophys_decrosstalk_roi_images_3 {
	...
	path 'capsule/results/*' into capsule_aind_ophys_decrosstalk_roi_images_3_to_capsule_aind_ophys_trace_extraction_5_10
...
process capsule_aind_ophys_trace_extraction_5 {
	tag 'capsule-5901951'
	container "$REGISTRY_HOST/published/1054eca7-5c8b-49a3-a921-c9ac78d88f01:v2"
	...
	path 'capsule/data/' from capsule_aind_ophys_decrosstalk_roi_images_3_to_capsule_aind_ophys_trace_extraction_5_10
	...
	export CO_CAPSULE_ID=1054eca7-5c8b-49a3-a921-c9ac78d88f01
	export CO_CPUS=1
	export CO_MEMORY=8589934592
	...
	echo "[${task.tag}] cloning git repo..."
	git clone --branch v2.0 "https://\$GIT_ACCESS_TOKEN@\$GIT_HOST/capsule-5901951.git" capsule-repo
	mv capsule-repo/code capsule/code
	rm -rf capsule-repo
